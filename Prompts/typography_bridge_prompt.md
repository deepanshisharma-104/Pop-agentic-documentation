# Master Prompt: Inside "bridge_doc" folder add a file named "typography_bridge.md" 
...
4. **Example Template:**
   ...
   Typescale token Name: | Display.XLarge.700 

   Codebase:  val DisplayLarge 

   File: POP Codebase /theme/PopTypography.kt

   Code Pattern:  val DisplayLarge = StyleSpec(
   ...
   1. **Extract from Design System File (type-scale.md ):**





2. **Match to Codebase (POP Codebase /theme/PopTypography):**
...
| Design System File | Design/typescale Token | Codebase File Name | Codebase variable name | Code Pattern |

|---|---|---|---|---|---|

| type-scale.md | Display.XLarge.700 | PopTypography.kt | `DisplayLarge` | `val DisplayLarge = StyleSpec(
                                                                              fontSize = 44,
                                                                              fontWeight = FontWeight.Bold,
                                                                              lineHeight = 52,
                                                                               letterSpacing = -2f
...
**Generated bridge file should be named:** `typography_bridge.md`
