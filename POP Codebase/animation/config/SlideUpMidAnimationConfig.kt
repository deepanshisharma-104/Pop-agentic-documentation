...
/**
 * Slide Up Mid animation configuration.
 ...
 * @param slideInOffsetPercent Vertical slide-in offset as percentage of screen height (default: 0.5f = 50%).
 ...
 */
data class SlideUpMidAnimationConfig(
    ...
    companion object {
        val Default = SlideUpMidAnimationConfig(
            screenId = null,
            slideInOffsetPercent = 0.5f,
