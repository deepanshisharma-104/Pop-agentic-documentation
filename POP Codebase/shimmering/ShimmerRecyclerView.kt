...
class ShimmerRecyclerView : RecyclerView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        var mShimmerMaskWidth: Float
        var isAnimationReversed: Boolean
        var mShimmerItemBackground: Drawable?
    ...
    private fun initShimmerManager() {
        when (mLayoutMangerType) {
            ...
            LayoutMangerType.LINEAR_HORIZONTAL -> mShimmerLayoutManager =
                object : LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false) {
            ...
            LayoutMangerType.GRID -> mShimmerLayoutManager =
                object : GridLayoutManager(getContext(), mGridCount) {
                    override fun canScrollVertically(): Boolean {
                        return mCanScroll
                    }
                }
